...
use jni_sys::{
    jint, JavaVM, JavaVMInitArgs, JNI_EVERSION, JNI_OK, JNI_VERSION_10, JNI_VERSION_1_1,
    JNI_VERSION_1_2, JNI_VERSION_1_4, JNI_VERSION_1_6, JNI_VERSION_1_8, JNI_VERSION_9,
};
